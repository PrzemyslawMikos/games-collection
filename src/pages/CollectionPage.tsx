  ...
  return (
    <div className="page-stack">
      ...
      <section className="toolbar panel">
        ...
        <label className="select-field mobile-filter-field"><span>{t('collection.filter')}</span><select value={filter} onChange={(event) => setFilter(event.target.value as typeof filter)}><option value="all">{t('collection.all')}</option><option value="owned">{t('collection.owned')}</option><option value="planned">{t('collection.plans')}</option><option value="sealed">{t('collection.sealed')}</option><option value="used">{t('collection.used')}</option></select></label>
      </section>
